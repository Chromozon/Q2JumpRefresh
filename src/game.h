...
{
	// special messages
	void	(*bprintf) (int printlevel, char *fmt, ...); // prints to all connected clients
	void	(*dprintf) (char *fmt, ...);
	void	(*cprintf) (edict_t *ent, int printlevel, char *fmt, ...); // prints to only the specified client
